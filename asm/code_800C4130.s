...
/* B3B2FC 800C415C 0C00084C */  jal   DebugMessage
...
/* B3B314 800C4174 0C035C26 */  jal   func_800D7098
...
/* B3B35C 800C41BC 0C035C26 */  jal   func_800D7098
...
/* B3B3A0 800C4200 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3B3A4 800C4204 8C42FA90 */  lw    $v0, %lo(D_8015FA90)($v0)
...
/* B3B4E4 800C4344 3C068016 */  lui   $a2, %hi(D_8015FA90) # $a2, 0x8016
/* B3B4E8 800C4348 24C6FA90 */  addiu $a2, %lo(D_8015FA90) # addiu $a2, $a2, -0x570
...
/* B3B610 800C4470 3C068016 */  lui   $a2, %hi(D_8015FA90) # $a2, 0x8016
/* B3B614 800C4474 24C6FA90 */  addiu $a2, %lo(D_8015FA90) # addiu $a2, $a2, -0x570
...
/* B3B630 800C4490 3C018001 */  lui   $at, 0x8001
...
/* B3B8D0 800C4730 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
...
/* B3B8EC 800C474C 8C42FA90 */  lw    $v0, %lo(D_8015FA90)($v0)
...
/* B3B904 800C4764 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3B908 800C4768 8C42FA90 */  lw    $v0, %lo(D_8015FA90)($v0)
...
/* B3B940 800C47A0 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3B944 800C47A4 8C42FA90 */  lw    $v0, %lo(D_8015FA90)($v0)
...
/* B3B988 800C47E8 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3B98C 800C47EC 8C42FA90 */  lw    $v0, %lo(D_8015FA90)($v0)
...
/* B3B9C0 800C4820 0C00084C */  jal   DebugMessage
/* B3B9C4 800C4824 00402825 */   move  $a1, $v0
/* B3B9C8 800C4828 3C088016 */  lui   $t0, %hi(D_8015FA90) # $t0, 0x8016
/* B3B9CC 800C482C 8D08FA90 */  lw    $t0, %lo(D_8015FA90)($t0)
...
/* B3BA24 800C4884 3C0E8016 */  lui   $t6, %hi(D_8015FA90) # $t6, 0x8016
/* B3BA28 800C4888 8DCEFA90 */  lw    $t6, %lo(D_8015FA90)($t6)
...
/* B3BC9C 800C4AFC 3C078016 */  lui   $a3, %hi(D_8015FA90) # $a3, 0x8016
/* B3BCA0 800C4B00 24E7FA90 */  addiu $a3, %lo(D_8015FA90) # addiu $a3, $a3, -0x570
...
/* B3BCDC 800C4B3C 3C018001 */  lui   $at, 0x8001
/* B3BCE0 800C4B40 24050002 */  li    $a1, 2
/* B3BCE4 800C4B44 ACD802E4 */  sw    $t8, 0x2e4($a2)
/* B3BCE8 800C4B48 C4249440 */  lwc1  $f4, -0x6bc0($at)
/* B3BCEC 800C4B4C 3C018001 */  lui   $at, 0x8001
/* B3BCF0 800C4B50 E4C402F4 */  swc1  $f4, 0x2f4($a2)
/* B3BCF4 800C4B54 C4269444 */  lwc1  $f6, -0x6bbc($at)
...
/* B3BD44 800C4BA4 3C078016 */  lui   $a3, %hi(D_8015FA90) # $a3, 0x8016
/* B3BD48 800C4BA8 24E7FA90 */  addiu $a3, %lo(D_8015FA90) # addiu $a3, $a3, -0x570
...
.L800C4CF8:
/* B3BE98 800C4CF8 3C018014 */  lui   $at, 0x8014
/* B3BE9C 800C4CFC C43050E8 */  lwc1  $f16, 0x50e8($at)
...
.L800C4D74:
/* B3BF14 800C4D74 3C048001 */  li    $a0, 0x80010000 # 0.000000
...
/* B3BFB8 800C4E18 3C018001 */  lui   $at, 0x8001
/* B3BFBC 800C4E1C 46080283 */  div.s $f10, $f0, $f8
/* B3BFC0 800C4E20 10000003 */  b     .L800C4E30
/* B3BFC4 800C4E24 E42A9444 */   swc1  $f10, -0x6bbc($at)
.L800C4E28:
/* B3BFC8 800C4E28 3C018001 */  lui   $at, 0x8001
/* B3BFCC 800C4E2C E4209444 */  swc1  $f0, -0x6bbc($at)
.L800C4E30:
...
/* B3C034 800C4E94 0C00084C */  jal   DebugMessage
...
/* B3C074 800C4ED4 0C00084C */  jal   DebugMessage
...
/* B3C098 800C4EF8 0C00084C */  jal   DebugMessage
...
/* B3C0A8 800C4F08 0C0359C3 */  jal   func_800D670C
...
/* B3C100 800C4F60 0C00084C */  jal   DebugMessage
...
/* B3C14C 800C4FAC 0C00084C */  jal   DebugMessage
...
/* B3C194 800C4FF4 0C00084C */  jal   DebugMessage
...
/* B3C1CC 800C502C 0C00084C */  jal   DebugMessage
...
/* B3C1F0 800C5050 0C00084C */  jal   DebugMessage
...
/* B3C208 800C5068 0C0359C3 */  jal   func_800D670C
...
/* B3C23C 800C509C 0C00084C */  jal   DebugMessage
...
/* B3C2C4 800C5124 0C00084C */  jal   DebugMessage
...
/* B3C338 800C5198 0C00084C */  jal   DebugMessage
...
/* B3C35C 800C51BC 3C0F8016 */  lui   $t7, %hi(D_8015FA90) # $t7, 0x8016
/* B3C360 800C51C0 8DEFFA90 */  lw    $t7, %lo(D_8015FA90)($t7)
...
/* B3C3D0 800C5230 0C00084C */  jal   DebugMessage
...
/* B3C428 800C5288 3C0A8016 */  lui   $t2, %hi(D_8015FA90) # $t2, 0x8016
/* B3C42C 800C528C 8D4AFA90 */  lw    $t2, %lo(D_8015FA90)($t2)
...
/* B3C4BC 800C531C 0C00084C */  jal   DebugMessage
...
/* B3C514 800C5374 0C00084C */  jal   DebugMessage
...
/* B3C5A8 800C5408 3C0E8016 */  lui   $t6, %hi(D_8015FA90) # $t6, 0x8016
/* B3C5AC 800C540C 8DCEFA90 */  lw    $t6, %lo(D_8015FA90)($t6)
...
/* B3C5E4 800C5444 0C0350B0 */  jal   func_800D42C0
...
/* B3C5F0 800C5450 0C00084C */  jal   DebugMessage
...
/* B3C654 800C54B4 0C00084C */  jal   DebugMessage
...
/* B3C690 800C54F0 0C00084C */  jal   DebugMessage
...
/* B3C6BC 800C551C 0C00084C */  jal   DebugMessage
...
/* B3C6D0 800C5530 0C00084C */  jal   DebugMessage
