...
/* B3984C 800C26AC 0C00084C */  jal   DebugMessage
...
/* B3A2B8 800C3118 3C038016 */  lui   $v1, %hi(D_8015FA90) # $v1, 0x8016
/* B3A2BC 800C311C 8C63FA90 */  lw    $v1, %lo(D_8015FA90)($v1)
...
/* B3A4FC 800C335C 0C00084C */  jal   DebugMessage
/* B3A500 800C3360 AFA20030 */   sw    $v0, 0x30($sp)
/* B3A504 800C3364 3C038016 */  lui   $v1, %hi(D_8015FA90) # $v1, 0x8016
/* B3A508 800C3368 8C63FA90 */  lw    $v1, %lo(D_8015FA90)($v1)
...
.L800C3824:
/* B3A9C4 800C3824 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3A9C8 800C3828 8C42FA90 */  lw    $v0, %lo(D_8015FA90)($v0)
