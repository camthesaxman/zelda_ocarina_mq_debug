...
/* B2A740 800B35A0 3C028016 */  lui   $v0, %hi(D_8015FA78) # $v0, 0x8016
...
/* B2A750 800B35B0 9042FA78 */  lbu   $v0, %lo(D_8015FA78)($v0)
...
/* B2A76C 800B35CC 3C028016 */  lui   $v0, %hi(D_8015FA78) # $v0, 0x8016
/* B2A770 800B35D0 A0F90001 */  sb    $t9, 1($a3)
/* B2A774 800B35D4 9042FA78 */  lbu   $v0, %lo(D_8015FA78)($v0)
.L800B35D8:
/* B2A778 800B35D8 54400007 */  bnezl $v0, .L800B35F8
/* B2A77C 800B35DC 94E80008 */   lhu   $t0, 8($a3)
/* B2A780 800B35E0 0C00084C */  jal   DebugMessage
/* B2A784 800B35E4 AFA70030 */   sw    $a3, 0x30($sp)
/* B2A788 800B35E8 3C028016 */  lui   $v0, %hi(D_8015FA78) # $v0, 0x8016
/* B2A78C 800B35EC 9042FA78 */  lbu   $v0, %lo(D_8015FA78)($v0)
...
.L800B366C:
/* B2A80C 800B366C 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B2A810 800B3670 8C42FA90 */  lw    $v0, %lo(D_8015FA90)($v0)
...
/* B2A838 800B3698 0C01DE5F */  jal   func_8007797C
/* B2A83C 800B369C AFA70030 */   sw    $a3, 0x30($sp)
/* B2A840 800B36A0 10400017 */  beqz  $v0, .L800B3700
/* B2A844 800B36A4 8FA70030 */   lw    $a3, 0x30($sp)
/* B2A848 800B36A8 3C0F8016 */  lui   $t7, %hi(D_8015FA90) # $t7, 0x8016
/* B2A84C 800B36AC 8DEFFA90 */  lw    $t7, %lo(D_8015FA90)($t7)
...
/* B2A864 800B36C4 0C01DE5F */  jal   func_8007797C
/* B2A868 800B36C8 AFA70030 */   sw    $a3, 0x30($sp)
/* B2A86C 800B36CC 3C188016 */  lui   $t8, %hi(D_8015FA90) # $t8, 0x8016
/* B2A870 800B36D0 8F18FA90 */  lw    $t8, %lo(D_8015FA90)($t8)
/* B2A874 800B36D4 27A4002A */  addiu $a0, $sp, 0x2a
/* B2A878 800B36D8 00002825 */  move  $a1, $zero
/* B2A87C 800B36DC 0C01DE5F */  jal   func_8007797C
/* B2A880 800B36E0 87060D38 */   lh    $a2, 0xd38($t8)
/* B2A884 800B36E4 10400006 */  beqz  $v0, .L800B3700
/* B2A888 800B36E8 8FA70030 */   lw    $a3, 0x30($sp)
/* B2A88C 800B36EC 3C198016 */  lui   $t9, %hi(D_8015FA90) # $t9, 0x8016
/* B2A890 800B36F0 8F39FA90 */  lw    $t9, %lo(D_8015FA90)($t9)
