...
/* AE6018 8006EE78 3C08008C */  lui   $t0, %hi(D_008C1000) # $t0, 0x8c
/* AE601C 8006EE7C AFBF001C */  sw    $ra, 0x1c($sp)
/* AE6020 8006EE80 25081000 */  addiu $t0, %lo(D_008C1000) # addiu $t0, $t0, 0x1000
...
/* AE6068 8006EEC8 3C19008C */  lui   $t9, %hi(D_008BA000) # $t9, 0x8c
...
/* AE607C 8006EEDC 2739A000 */  addiu $t9, %lo(D_008BA000) # addiu $t9, $t9, -0x6000
...
/* AE60FC 8006EF5C 3C18008C */  lui   $t8, %hi(D_008C6000) # $t8, 0x8c
/* AE6100 8006EF60 0080A825 */  move  $s5, $a0
/* AE6104 8006EF64 AC820000 */  sw    $v0, ($a0)
/* AE6108 8006EF68 AC860004 */  sw    $a2, 4($a0)
/* AE610C 8006EF6C 27186000 */  addiu $t8, %lo(D_008C6000) # addiu $t8, $t8, 0x6000
...
/* AE6148 8006EFA8 0C00084C */  jal   DebugMessage
...
/* AE617C 8006EFDC 0C00084C */  jal   DebugMessage
...
/* AE61AC 8006F00C 3C14008C */  lui   $s4, %hi(D_008C1000) # $s4, 0x8c
/* AE61B0 8006F010 26941000 */  addiu $s4, %lo(D_008C1000) # addiu $s4, $s4, 0x1000
/* AE61B4 8006F014 26733C88 */  addiu $s3, $s3, 0x3c88
/* AE61B8 8006F018 0C00084C */  jal   DebugMessage
