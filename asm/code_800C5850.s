...
/* B3C9F8 800C5858 0C0011D0 */  jal   func_80004740
...
.L800C5894:
/* B3CA34 800C5894 0C0019A4 */  jal   func_80006690
/* B3CA38 800C5898 00000000 */   nop   
/* B3CA3C 800C589C 0C035213 */  jal   func_800D484C
/* B3CA40 800C58A0 00000000 */   nop   
/* B3CA44 800C58A4 0C0019A4 */  jal   func_80006690
...
/* B3CA5C 800C58BC 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3CA60 800C58C0 2442FA90 */  addiu $v0, %lo(D_8015FA90) # addiu $v0, $v0, -0x570
...
/* B3CA98 800C58F8 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3CA9C 800C58FC 2442FA90 */  addiu $v0, %lo(D_8015FA90) # addiu $v0, $v0, -0x570
...
/* B3CADC 800C593C 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3CAE0 800C5940 2442FA90 */  addiu $v0, %lo(D_8015FA90) # addiu $v0, $v0, -0x570
...
.L800C5A00:
/* B3CBA0 800C5A00 0C00084C */  jal   DebugMessage
...
/* B3CBB0 800C5A10 0C00084C */  jal   DebugMessage
...
/* B3CBC0 800C5A20 0C00084C */  jal   DebugMessage
...
/* B3CBD0 800C5A30 0C00084C */  jal   DebugMessage
...
/* B3CBE0 800C5A40 0C00084C */  jal   DebugMessage
...
/* B3CBF0 800C5A50 0C00084C */  jal   DebugMessage
...
/* B3CC00 800C5A60 0C00084C */  jal   DebugMessage
...
/* B3CC10 800C5A70 0C00084C */  jal   DebugMessage
...
/* B3CC20 800C5A80 0C00084C */  jal   DebugMessage
...
/* B3CC30 800C5A90 0C00084C */  jal   DebugMessage
...
/* B3CE7C 800C5CDC 0C000B84 */  jal   DebugMessageWithThreadId
...
/* B3CE8C 800C5CEC 0C00084C */  jal   DebugMessage
...
/* B3CEC4 800C5D24 3C018001 */  lui   $at, 0x8001
...
/* B3CEE4 800C5D44 C4249440 */  lwc1  $f4, -0x6bc0($at)
/* B3CEE8 800C5D48 3C018001 */  lui   $at, 0x8001
/* B3CEEC 800C5D4C 24E50038 */  addiu $a1, $a3, 0x38
/* B3CEF0 800C5D50 E4E402F4 */  swc1  $f4, 0x2f4($a3)
/* B3CEF4 800C5D54 C4269444 */  lwc1  $f6, -0x6bbc($at)
...
/* B3CF1C 800C5D7C 0C035077 */  jal   func_800D41DC
...
/* B3CF48 800C5DA8 0C0350B0 */  jal   func_800D42C0
...
/* B3D028 800C5E88 0C00084C */  jal   DebugMessage
...
/* B3D034 800C5E94 0C00084C */  jal   DebugMessage
...
/* B3D040 800C5EA0 0C00084C */  jal   DebugMessage
...
/* B3D070 800C5ED0 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3D074 800C5ED4 3C048013 */  lui   $a0, %hi(D_8012D260) # $a0, 0x8013
/* B3D078 800C5ED8 8C84D260 */  lw    $a0, %lo(D_8012D260)($a0)
/* B3D07C 800C5EDC 2442FA90 */  addiu $v0, %lo(D_8015FA90) # addiu $v0, $v0, -0x570
...
/* B3D0CC 800C5F2C 0C0359AD */  jal   func_800D66B4
...
/* B3D280 800C60E0 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3D284 800C60E4 8C42FA90 */  lw    $v0, %lo(D_8015FA90)($v0)
...
/* B3D2FC 800C615C 3C0A8016 */  lui   $t2, %hi(D_8015FA90) # $t2, 0x8016
...
/* B3D33C 800C619C 8D4AFA90 */  lw    $t2, %lo(D_8015FA90)($t2)
...
/* B3D5B0 800C6410 3C088016 */  lui   $t0, %hi(D_8015FA90) # $t0, 0x8016
/* B3D5B4 800C6414 2508FA90 */  addiu $t0, %lo(D_8015FA90) # addiu $t0, $t0, -0x570
...
/* B3D640 800C64A0 0C035077 */  jal   func_800D41DC
/* B3D644 800C64A4 8E0601B0 */   lw    $a2, 0x1b0($s0)
.L800C64A8:
/* B3D648 800C64A8 0C03162F */  jal   func_800C58BC
/* B3D64C 800C64AC 8E0401B0 */   lw    $a0, 0x1b0($s0)
/* B3D650 800C64B0 3C088016 */  lui   $t0, %hi(D_8015FA90) # $t0, 0x8016
/* B3D654 800C64B4 2508FA90 */  addiu $t0, %lo(D_8015FA90) # addiu $t0, $t0, -0x570
...
/* B3D670 800C64D0 0C0350B0 */  jal   func_800D42C0
/* B3D674 800C64D4 24846648 */   addiu $a0, %lo(D_80166648) # addiu $a0, $a0, 0x6648
/* B3D678 800C64D8 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3D67C 800C64DC 8C42FA90 */  lw    $v0, %lo(D_8015FA90)($v0)
...
/* B3D6A4 800C6504 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3D6A8 800C6508 8C42FA90 */  lw    $v0, %lo(D_8015FA90)($v0)
...
/* B3D724 800C6584 0C0359C3 */  jal   func_800D670C
...
/* B3D770 800C65D0 0C0359C3 */  jal   func_800D670C
...
/* B3D958 800C67B8 3C018016 */   lui   $at, %hi(D_8015F9BC) # $at, 0x8016
/* B3D95C 800C67BC AC20F9BC */  sw    $zero, %lo(D_8015F9BC)($at)
...
/* B3D9A4 800C6804 0C00084C */  jal   DebugMessage
/* B3D9A8 800C6808 248454DC */   addiu $a0, %lo(D_801454DC) # addiu $a0, $a0, 0x54dc
/* B3D9AC 800C680C 8FB800CC */  lw    $t8, 0xcc($sp)
/* B3D9B0 800C6810 3C098009 */  lui   $t1, %hi(func_800924B8) # $t1, 0x8009
/* B3D9B4 800C6814 252924B8 */  addiu $t1, %lo(func_800924B8) # addiu $t1, $t1, 0x24b8
...
/* B3DA24 800C6884 0C00084C */  jal   DebugMessage
...
/* B3DA6C 800C68CC 0C00084C */  jal   DebugMessage
...
/* B3DA8C 800C68EC 0C00084C */  jal   DebugMessage
...
/* B3DAB0 800C6910 0C0359AD */  jal   func_800D66B4
...
/* B3DB34 800C6994 0C00084C */  jal   DebugMessage
...
/* B3DB70 800C69D0 3C0E8016 */  lui   $t6, %hi(D_8015FA90) # $t6, 0x8016
/* B3DB74 800C69D4 8DCEFA90 */  lw    $t6, %lo(D_8015FA90)($t6)
...
/* B3DBB4 800C6A14 0C00084C */  jal   DebugMessage
...
/* B3DBEC 800C6A4C 3C0E8016 */  lui   $t6, %hi(D_8015FA90) # $t6, 0x8016
/* B3DBF0 800C6A50 8DCEFA90 */  lw    $t6, %lo(D_8015FA90)($t6)
...
/* B3DC30 800C6A90 0C00084C */  jal   DebugMessage
...
/* B3DC64 800C6AC4 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3DC68 800C6AC8 8C42FA90 */  lw    $v0, %lo(D_8015FA90)($v0)
...
/* B3DCF4 800C6B54 3C028016 */  lui   $v0, %hi(D_8015FA90) # $v0, 0x8016
/* B3DCF8 800C6B58 8C42FA90 */  lw    $v0, %lo(D_8015FA90)($v0)
