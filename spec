...
beginseg
    ...
    include "build/src/libultra/libultra_os.o"
    include "build/src/libultra/osStopThread.o"
    include "build/src/libultra/os80003270.o"
    include "build/src/libultra/osRecvMesg.o"
    ...
    include "build/src/libultra/osCreateThread.o"
    ...
    include "build/src/libultra/osVirtualToPhysical.o"
    include "build/asm/boot_80004E60.o"
    include "build/asm/boot_80004ED0.o"
    include "build/src/libultra/osGetThreadId.o"
    ...
    include "build/src/libultra/osSetThreadPri.o"
    include "build/src/libultra/osGetThreadPri.o"
    ...
    include "build/src/libultra/osGetTime.o"
    ...
    include "build/src/libultra/osStartThread.o"
...
beginseg
    ...
    include "build/textures/icon_item_nes_static.o"
endseg
...
beginseg
    name "code"
    include "build/asm/z_en_a_keep.o"
    include "build/asm/z_en_item00.o"
    include "build/asm/z_eff_blure.o"
    include "build/asm/z_eff_shield_particle.o"
    include "build/asm/z_eff_spark.o"
    include "build/asm/z_eff_ss_dead.o"
    include "build/asm/z_effect_soft_sprite.o"
    include "build/asm/z_effect_soft_sprite_old_init.o"
    include "build/asm/flg_set.o"
    include "build/asm/z_DLF.o"
    ...
    include "build/asm/z_kankyo.o"
    include "build/asm/code_800777E0.o"
    include "build/asm/z_lifemeter.o"
    include "build/asm/z_lights.o"
    include "build/asm/code_8007AE10.o"
    include "build/asm/z_map_mark.o"
    include "build/asm/z_moji.o"
    ...
    include "build/src/libultra/osDpGetStatus.o"
    include "build/src/libultra/osDpSetStatus.o"
    ...
    include "build/src/code_80106760.o"
    include "build/src/code_801067A0.o"
